...
public class runner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Prenotazione prenotazione2 = new Prenotazione(LocalDate.now(), postazione2, utente2);
		Prenotazione prenotazione3 = new Prenotazione(LocalDate.now(), postazione3, utente3);
		Prenotazione prenotazione4 = new Prenotazione(LocalDate.now(), postazione4, utente4);
